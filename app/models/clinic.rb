class Clinic < ApplicationRecord
  ...
  ADMIN_PERSIT_PARAMS = [:name, :phone_number, :district_id, :address, :website, :facebook, doctor_attributes: [:id, :avatar, :first_name, :last_name, :dob, :gender, :phone_number, user_attributes: [:id, :email, :password, :password_confirmation, :username, :role]]]
